...
export default function AnimatedGradient() {
    return (
        <div className="flex">
            <motion.button
                className="group relative flex items-center gap-3 px-6 py-3 bg-gray-800 hover:bg-gray-750 border border-gray-700 rounded-full transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20"
